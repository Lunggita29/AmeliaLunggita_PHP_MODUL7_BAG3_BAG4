...
$query = "SELECT kode, nama_matkul, sks, semester, matakuliah, id_dosen, nama_dosen
            FROM matakuliah LEFT JOIN dosen USING (id dosen)
            WHERE kode = '$kode'";
...
<body>
    ...
    <td><input type="text" name="kode" id="kode" value="<?php echo $data_dosen['kode']; ?>">
    </tr>
    <tr>
    <td><label for="nama_matkul">Matakuliah</label></td> <td> : </td>
    <td><input type="text" name="nama_matkul" id="nama_matkul" value="<?php echo $data_dosen['kode']; ?>"> </td>
    </tr>
    <tr>
